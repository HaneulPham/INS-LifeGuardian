...
| DEC-002 | 2026-07-18 | Device Setup Steps | Generate CAMS Asset must be positioned after Assign To Client File | SMAR-2652 approved requirement and error-message confirmation | Confirmed | SMAR-2652 | N/A | Deleting Assign To Client File is blocked while Generate CAMS Asset exists |
